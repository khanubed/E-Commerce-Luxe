...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("LuxeStore Inquiry:", formData);
  };
    ...
    <main className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-12 gap-20">
        ...
        <div className="lg:col-span-7">
          <h2 className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 mb-12">Submit an Inquiry</h2>
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            >
              Dispatch Message <Send size={14} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
            </button>
          </form>
        </div>
        ...
        <div className="lg:col-span-5 space-y-16">
          <div className="p-10 border border-slate-900 bg-white">
            <h3 className="text-xl font-black uppercase tracking-tighter mb-8">Global HQ</h3>
            <div className="space-y-6">
              <ContactInfo icon={<MapPin size={18} />} label="Address" value="7th Floor, Luxe Tower, NYC" />
              <ContactInfo icon={<Phone size={18} />} label="Telephone" value="+1 (800) LUXE-STR" />
              <ContactInfo icon={<Clock size={18} />} label="Hours" value="Mon - Sun | 24 Hours" />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-200 border border-slate-200">
             <div className="bg-white p-10 flex flex-col gap-4">
                ...
                <h4 className="font-black uppercase text-xs tracking-widest">Global Shipping</h4>
                <p className="text-xs text-slate-500 font-medium">Complimentary insured delivery on all orders over $500.</p>
             </div>
             <div className="bg-white p-10 flex flex-col gap-4">
                <Headset size={24} className="text-amber-600" />
                <h4 className="font-black uppercase text-xs tracking-widest">24/7 Concierge</h4>
                <p className="text-xs text-slate-500 font-medium">Direct access to our style consultants anytime, anywhere.</p>
             </div>
             <div className="bg-white p-10 flex flex-col gap-4">
                <CalendarClock size={24} className="text-amber-600" />
                <h4 className="font-black uppercase text-xs tracking-widest">Appointments</h4>
                <p className="text-xs text-slate-500 font-medium">Book a private virtual or in-person viewing of our collection.</p>
             </div>
          </div>
        </div>
      </section>
